...
import { clearProductsCache, getProductsResource } from '../api/products';
import { useSearchParams } from 'react-router-dom';
import FilterComponent from './ui/atoms/FilterComponent';
import PaginationComponent from './ui/atoms/PaginationComponent';
...
export default function ProductListDashboard() {
  ...
  const { data: products, pagination } = productsFull;
  ...
  return (
    <div className="container p-6 min-w-full">
      <header className="mb-10 lg:ml-[250px] text-center">
          ...
          {products.map(product => {
            ...
            return (
              ...
              >
                ...
                font-bold backdrop-blur bg-red-600 bg-opacity-30 text-white z-[10]
              ">
                    SOLD OUT
                  </div>
                }
                ...
                <div className="overflow-hidden rounded-2xl mb-4 relative">
                  ...
                  />
                  {
                    !!(product.stock > 0) && (<button className={`
      ...
      <div className='flex justify-center lg:ml-[250px]'>
